import os
import honeyhive
from honeyhive_logger import start, log, update, _retry_with_backoff
import uuid
...
def test_log_event():
    ...
    # Skip feedback assertion as it may not be immediately available in the API
...
def test_log_event_with_metrics():
    ...
    # Skip metrics assertion as it may not be immediately available in the API
